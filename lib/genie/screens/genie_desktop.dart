...
class GenieDesktop extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    Color greyColor = ColorConverter().hexToColor('#E3E3E3');
      ...
      child: Column(
        children: [
          ...
          Row(
            ...
            children: [
              Image.asset("images/message-question.png"),
              const SizedBox(width: 5),
              Text(
                "How does this work and why do I have to answer questions?",
                style: TextStyle(
                    fontFamily: 'Spectral',
                    fontSize: 16,
